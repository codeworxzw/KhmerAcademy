...
public class Setting {
    ...
    public static Typeface getTypeface(Context context) {
        if (getLanguage(context).equals("km")) {
            Typeface font = Typeface.createFromAsset(context.getAssets(), "fonts/Battambang-Regular.ttf");
            return font;
        }
        return Typeface.createFromAsset(context.getAssets(), "fonts/Tinos-Regular.ttf");
    }
    ...
    public static void readSetting(Context context) {
        sharedPref = context.getSharedPreferences(sharedPrefName, Context.MODE_PRIVATE);
        LANGUAGE = sharedPref.getString("LANGUAGE", "km");
